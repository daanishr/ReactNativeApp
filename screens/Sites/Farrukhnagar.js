...
export default class Farrukhnagar extends Component {
    ...
    />
               ...
               <Image source={require('../../img/ncrsiteadv.jpg')} style={{
                ...
                <Image source={require('../../img/ncrsitelocation.jpg')} style={{
                    ...
                    <Text style={{ fontSize: 20, fontWeight: "bold", padding: 10 , color:"red" }}>
                        Layout               </Text>
                    <Image source={require('../../img/ncrlayout.jpg')} style={{   alignSelf: 'center', height: 250,
    width: Dimensions.get('window').width}}   resizeMode="contain" 
    defaultSource={{uri: require('../../img/Loading.png'), width: Dimensions.get('window').width, height: 200}}
    onLoadStart={(e) => this.setState({ loading: true })}
    onLoadEnd={(e) => this.setState({ loading: false })}
    ...
    <Text style={{ fontSize: 20, fontWeight: "bold", padding: 10, color: "red" }}>
                        ICD Side view of the site               </Text>
                    <Image source={require('../../img/ncricd.jpg')} style={{
                        alignSelf: 'center', height: 250,
                        width: Dimensions.get('window').width
                    }} resizeMode="contain"
                        defaultSource={{ uri: require('../../img/Loading.png'), width: Dimensions.get('window').width, height: 200 }}
                    ...
                    <Image source={require('../../img/ncrfrontelev.jpg')} style={{
                        alignSelf: 'center', height: 250,
                        width: Dimensions.get('window').width
                    }} resizeMode="contain"
                        defaultSource={{ uri: require('../../img/Loading.png'), width: Dimensions.get('window').width, height: 200 }}
